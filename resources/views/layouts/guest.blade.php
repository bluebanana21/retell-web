            ...
            <div class="min-h-screen flex flex-col sm:justify-center items-center pt-20 sm:pt-0 bg-gray-100">
                <div>
                    <a href="/" class="flex items-center space-x-3 mb-6">
                        <div class="w-12 h-12 bg-gradient-to-br from-teal-400 to-teal-600 rounded-lg flex items-center justify-center shadow-md">
                            <span class="text-white text-xl font-bold">R</span>
                        </div>
                        <h1 class="font-joan text-3xl font-semibold" style="color: #006B83;">RETELL</h1>
                    </a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Sistem pemesanan kamar hotel terpercaya dengan layanan terbaik untuk kenyamanan Anda.</p>
                </div>
                <div class="col-md-4">
                    <h6 class="mb-3">Quick Links</h6>
                    <ul class="list-unstyled">
                        <li><a href="{{ route('home') }}" class="text-muted text-decoration-none">Home</a></li>
                        <li><a href="{{ route('guest.hotels') }}" class="text-muted text-decoration-none">Hotels</a></li>
