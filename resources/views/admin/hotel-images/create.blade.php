...
@section('title', 'Tambah Hotel Image')
...
@section('breadcrumb')
    ...
    <li class="inline-flex items-center">
        <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
        <span class="text-gray-500">Tambah Hotel Image</span>
    </li>
@endsection
...
<div class="bg-white/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20">
    ...
    <div class="p-6 border-b border-gray-200/50 flex items-center space-x-3">
        ...
        <h3 class="text-xl font-bold text-gray-900">Tambah Hotel Image</h3>
    </div>
    
    <!-- Form -->
    <form action="{{ route('admin.hotel-images.store') }}" method="POST" class="p-6" enctype="multipart/form-data">
        @csrf
