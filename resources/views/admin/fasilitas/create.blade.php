...
@section('breadcrumb')
    ...
    <li class="inline-flex items-center">
        <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
        <span class="text-gray-500">Tambah Fasilitas</span>
    </li>
@endsection
    ...
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20">
        ...
        <div class="p-6 border-b border-gray-200/50">
            <div class="flex items-center space-x-3">
                ...
                <h3 class="text-xl font-bold text-gray-900">Tambah Fasilitas Baru</h3>
            </div>
        </div>
        
        <!-- Form -->
        <form action="{{ route('admin.fasilitas.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl">
                        <div class="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center" id="iconPreview">
                            <i class="fas fa-star text-white text-lg" id="previewIcon"></i>
                        </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4"
                              ...
                              placeholder="Deskripsi singkat tentang fasilitas ini...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
