...
@section('breadcrumb')
    ...
    <li class="inline-flex items-center">
        <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
        <span class="text-gray-500">Tambah Kamar</span>
    </li>
@endsection
    ...
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20">
        ...
        <div class="p-6 border-b border-gray-200/50">
            <div class="flex items-center space-x-3">
                ...
                <h3 class="text-xl font-bold text-gray-900">Tambah Kamar Baru</h3>
            </div>
        </div>
        
        <!-- Form -->
        <form action="{{ route('admin.kamar.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="detail_id" id="detail_id" 
                        ...
                        @foreach($detailKamars as $detail)
                            <option value="{{ $detail->detail_id }}" {{ old('detail_id') == $detail->detail_id ? 'selected' : '' }}>
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <select name="status" id="status" 
                        ...
                        <option value="dibooked" {{ old('status') == 'dibooked' ? 'selected' : '' }}>Dibooked</option>
